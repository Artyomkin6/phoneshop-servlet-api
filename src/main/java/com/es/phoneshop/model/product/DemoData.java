...
public class DemoData {
    public void setDemoProducts(ProductDao dao) {
        ...
        products.add(new Product("sgs", "Samsung Galaxy S", new BigDecimal(0), usd, 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg"));
